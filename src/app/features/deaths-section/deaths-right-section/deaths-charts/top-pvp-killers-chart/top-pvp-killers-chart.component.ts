...
@Component({
  ...
  selector: 'app-top-pvp-killers-chart',
  templateUrl: './top-pvp-killers-chart.component.html',
  styleUrl: './top-pvp-killers-chart.component.scss',
  imports: [ChartModule, NoDataStatusComponent],
})
export class TopPvpKillersChartComponent {
